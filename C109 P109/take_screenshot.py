    ...
    if results.multi_hand_landmarks:
        for hand_landmark in results.multi_hand_landmarks:
            ...
            for tip in finger_tips:
                ...
                #writing condition to check if finger is folded i.e checking if 
                #finger tip starting value is smaller than finger starting 
                #position which is inner landmark. for index finger  
